...
export default function TodoItem({todo}) {
    ...
    // will be used for visual aspect only
    const toggleCompleted=()=>{
        toggleComplete(todo.id)
    }
    //this is just one todo item 
    return (
    <div
    ...
    <input type="text" className={`border outline-none w-full bg-transparent rounded-lg ${isTodoEditable? 
